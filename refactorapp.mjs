...
function get4chanBundle_webmOnlyMode() {


    
    console.log("webM only mode function is running");
    ...
    axios
        ...
        .then((res) => {
            ...
            do {
                ...
                postExt = boardDecision.ext; //gets value of ws_board property (0 is nsfw, 1 is sfw.)



                if (postExt == "webm") {
                    isWebM = "YES!"; 
                    console.log(`is WebM?: ${isWebM}`);
                    console.log("checkpoint two - webm");
                    continue;
                } else if (postExt != "webm") {
                    isWebM = "NO!";
                    console.log(`is Webm?: ${isWebM}`);
                    console.log("checkpoint two -non-webm");
                    onlyBoard = boardDecision.board;
...
app.get("/webmOnlyMode", (req, res)=> {
    res.json(JSON.stringify(get4chanBundle_webmOnlyMode()));
})
